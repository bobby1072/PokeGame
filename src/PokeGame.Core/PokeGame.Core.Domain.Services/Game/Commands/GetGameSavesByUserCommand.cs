...
internal sealed class GetGameSavesByUserCommand : IDomainCommand<Schemas.Game.User, DomainCommandResult<IReadOnlyCollection<GameSave>>>
{
    ...
    public GetGameSavesByUserCommand(ILogger<GetGameSavesByUserCommand> logger, IGameSaveRepository gameSaveRepository)
    {
        _logger = logger;
        _gameSaveRepository = gameSaveRepository;
    }

    public async Task<DomainCommandResult<IReadOnlyCollection<GameSave>>> ExecuteAsync(Schemas.Game.User user, CancellationToken cancellationToken = default)
    {
