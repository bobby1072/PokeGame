...
internal sealed class GetOwnedPokemonInDeckByConnectionIdCommand
    ...
    )>
{
    ...
    public GetOwnedPokemonInDeckByConnectionIdCommand(
    ...
    public override async Task<DomainCommandResult<IReadOnlyCollection<OwnedPokemon>>> ExecuteAsync(
        (bool DeepVersion, string ConnectionId, Schemas.Game.User CurrentUser) input,
