...
internal sealed class GetUserByIdCommand : IDomainCommand<Guid, DomainCommandResult<Schemas.Game.User>>
{
    ...
    public async Task<DomainCommandResult<Schemas.Game.User>> ExecuteAsync(Guid input,
